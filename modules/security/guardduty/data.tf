...
# ------------------------------------------------------------------------------
# Retrieve all descendant accounts for each CT-managed OU. This includes
# accounts in any nested sub-OUs beneath the top-level OU.
# ------------------------------------------------------------------------------
data "aws_organizations_organizational_unit_descendant_accounts" "ct_managed" {
  for_each  = local.ct_managed_ou_ids
  provider  = aws.org-management
